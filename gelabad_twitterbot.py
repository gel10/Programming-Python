...
#for slack bot
token = "xoxp-36519852806-42258330454-46171691764-a1ae678b7c"  #get this value from slack.
                ...
                while True:
                    ...
                    for item in lst:
                        ...
                        sc.api_call(
                            ...
                            text = str1,
                            username='twitterbot',
                            icon_emoji="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTfDmYElgV70NP1v72VBKk6ed-uLrcso93mMQKo1ZlxyJRZGuHmAE6PSuvD"
                            )
                        sc.rtm_read()
                        time.sleep(3600)
